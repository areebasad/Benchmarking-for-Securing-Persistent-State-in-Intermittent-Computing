...
def atprogram(project_path=None, device_name="ATSAML21J18B", verbose=0,
...
def get_device_info(
        device_name="ATSAML21J18B", verbose=0, tool="EDBG", interface="SWD",
...
def get_project_size(
        project_path, device_name="ATSAML21J18B", verbose=0, tool="EDBG",
